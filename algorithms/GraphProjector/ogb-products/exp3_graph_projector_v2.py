...
if args.use_adapt_gcs:
    fn = os.path.join(os.getcwd(), "graph_projector_models",
                      "exp3_gc_graph_projector_%d_%d.pt" % (args.num_remove_nodes, args.hop_neighbors))
else:
    fn = os.path.join(os.getcwd(), "graph_projector_models",
                      "exp3_graph_projector_%d_%d.pt" % (args.num_remove_nodes, args.hop_neighbors))
...
for cnt, delete_node_batch_i in enumerate(delete_node_batch):
    ...
    # save every model ... in case shit happens ...
